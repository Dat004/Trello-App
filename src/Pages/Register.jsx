        ...
        <section className="h-screen">
          <section className="relative h-full flex items-center justify-center">
            ...
            <section className="relative max-w-[400px] w-full">
              <section className="py-4 px-6 sm:shadow-xl sm:py-8 sm:px-10 rounded-sm space-y-6">
                <section className="text-center">
                  <span className="block h-10">
                    <svg className="mx-auto" height="100%" viewBox="0 0 113 32">
                      <path
                  ...
                  <h3 className="pt-4 text-base font-semibold text-muted-foreground">
